...
func (x *CreatePositionRequest) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *CreatePositionResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CreatePositionResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreatePositionResponse) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x52, 0x0a, 0x16, 0x43, 0x72, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x48, 0x0a,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x70,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x22, 0x2f, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x44, 0x32, 0xd2, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x69, 0x0a, 0x0e, 0x43, 0x72, 0x65,
	...
	0x13, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x2f, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x57, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72,
	...
	0x2a, 0x22, 0x0a, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x42, 0x10, 0x5a,
...
var file_order_order_proto_goTypes = []any{
	(*CreatePositionRequest)(nil),  // 0: api.CreatePositionRequest
	(*CreatePositionResponse)(nil), // 1: api.CreatePositionResponse
...
var file_order_order_proto_depIdxs = []int32{
	0, // 0: api.OrderService.CreatePosition:input_type -> api.CreatePositionRequest
	2, // 1: api.OrderService.CreateOrder:input_type -> api.CreateOrderRequest
	1, // 2: api.OrderService.CreatePosition:output_type -> api.CreatePositionResponse
